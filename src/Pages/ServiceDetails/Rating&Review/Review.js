    ...
    <div>
      ...
      <div className="flex flex-col mt-4">
        <div className="flex items-center space-x-1">
          ...
          <progress className="progress progress-warning w-56" value="83" max="100"></progress>
          <span className="flex-shrink-0 w-12 text-sm text-right">83%</span>
        </div>
        <div className="flex items-center space-x-1">
          <span className="flex-shrink-0 w-12 text-sm">4 star</span>
          <progress className="progress progress-warning w-56" value="67" max="100"></progress>
        ...
        <div className="flex items-center space-x-1">
          ...
          <progress className="progress progress-warning w-56" value="33" max="100"></progress>
          <span className="flex-shrink-0 w-12 text-sm text-right">33%</span>
        </div>
        <div className="flex items-center space-x-1">
          <span className="flex-shrink-0 w-12 text-sm">1 star</span>
          <progress className="progress progress-warning w-56" value="17" max="100"></progress>
