    ...
    <div className="flex md:flex-row flex-col justify-center items-center my-10">
      ...
      <div className="w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100 shadow-2xl">
        ...
        <div className="flex justify-center space-x-4">
          <button aria-label="Log in with Google" className="p-3 rounded-sm" onClick={handleSignInGoogle}>
            <svg
          ...
          <button aria-label="Log in with GitHub" className="p-3 rounded-sm" onClick={handleSignInGit}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 32 32"
              className="w-5 h-5 fill-current"
