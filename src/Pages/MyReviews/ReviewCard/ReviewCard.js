    ...
    <li className={`flex flex-col py-6 sm:flex-row sm:justify-between hover:bg-gray-800 px-2 hover:rounded`} 
      ...
      <div className="flex w-full space-x-2 sm:space-x-4">
        <img
          ...
          src={value.thum||"https://images.unsplash.com/photo-1504274066651-8d31a536b11a?ixlib=rb-1.2.1&amp;ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&amp;auto=format&amp;fit=crop&amp;w=675&amp;q=80"}
          alt=""
        />
        <div className="flex flex-col justify-between w-full pb-4">
          <div className="flex justify-between w-full pb-2 space-x-2">
            <div className="space-y-1">
              ...
              <p className="text-sm dark:text-gray-400">{value.shortDesc.slice(0,20)+"..."}</p>
              <p className="text-sm dark:text-gray-600"><em>Message: {value.message.slice(0,10)+"..."}</em></p>
            </div>
            <div className="text-right">
              <p className="text-lg font-semibold">${value.price}</p>
              <p className="text-sm dark:text-gray-600">Rating {value.rating}</p>
            </div>
          </div>
